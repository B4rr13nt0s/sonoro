...
// Cache en memoria del proceso: data/catalog.json lo regenera
// scripts/import-catalog.ts como paso de build, no cambia mientras el
...
export const staticAdapter: CatalogAdapter = { getProduct, listProducts, listBrands };
