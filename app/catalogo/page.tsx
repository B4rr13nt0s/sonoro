...
const TITULO = "Todo el catálogo — Sonoro";
const DESCRIPCION =
  "Todo el catálogo de Sonoro: bocinas, subwoofers, amplificadores, receptores, kits, insonorización y accesorios. Envíos a toda Guatemala.";
    ...
    <div className="flex flex-col">
      <section className="flex flex-col gap-6 px-6 pt-10 pb-6 sm:flex-row sm:items-end sm:justify-between sm:px-12 sm:pt-14 sm:pb-8">
        <div className="flex flex-col gap-3">
          <Breadcrumbs items={[{ label: "Inicio", href: "/" }, { label: "Todo el catálogo" }]} />
